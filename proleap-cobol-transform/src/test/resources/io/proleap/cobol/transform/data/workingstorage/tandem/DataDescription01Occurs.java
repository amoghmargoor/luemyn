...
@Singleton
public class DataDescription01Occurs {
    ...
    */
    ...
    public class ITEMSType {                                                                         //   (5)  01 ITEMS OCCURS 2 TIMES.
    ...
    protected List<ITEMSType> items = new ArrayList<ITEMSType>();
    {
        items.add(new ITEMSType());
        items.add(new ITEMSType());
    }
}
